...
public class AdminHome extends javax.swing.JFrame {
    ...
    */
    public AdminHome() {
        ...
        tableModel = (DefaultTableModel) jTableListOrderExport.getModel();
        setCellsAlignment(jTableListOrderExport, SwingConstants.CENTER);
        showOrderExport();
    }
    ...
    */
    private void showOrderExport() {
        try {
            ...
            listOrderExport.forEach((oe) -> {
                tableModel.addRow(new Object[]{tableModel.getRowCount() + 1, oe.getOrd_Ex_Num(), oe.getCusID(), oe.getDateOrdered(), oe.getTransID(),
