--SET MUI GIO VIET NAM CHO DATABASE
...
PRONAME PRODUCT.PRONAME%TYPE,
PROPRICE PRODUCT.PROPRICE%TYPE,
FARMID PRODUCT.FARMID%TYPE,
PROTYPE PRODUCT.PROTYPE%TYPE )
AS
BEGIN
...
END;
--8. THEM 1 NONG TRAI
CREATE OR REPLACE PROCEDURE P_INSERT_FARM (
FARMNAME FARM.FARMNAME%TYPE,
FARMADD FARM.FARMADD%TYPE )
AS
BEGIN
INSERT INTO FARM ( FARMNAME,
                    FARMADD )
                    VALUES (
                    FARMNAME,
                    FARMADD );
COMMIT;
END;
--9. THEM 1 NGUYEN LIEU
CREATE OR REPLACE PROCEDURE P_INSERT_RESOURCES (
RE_NAME RESOURCES.RE_NAME%TYPE,
REPRICE RESOURCES.REPRICE%TYPE,
UNIT RESOURCES.UNIT%TYPE )
AS
BEGIN
INSERT INTO RESOURCES ( RE_NAME,
                        REPRICE,
                        UNIT )
                        VALUES (
                        RE_NAME,
